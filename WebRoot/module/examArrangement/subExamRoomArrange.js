...
Ext.extend(system.application.baseClass,{
    ...
    initListener:function(){
   	...
   	initComponent :function(){
   		...
   		this.tabPanel = new Ext.TabPanel({   
       		...
       		border:false,
            items: [this.mainPanel,this.arrangePanel]   
        }); 
	},
	createMainExamRoomPanel:function(){
		...
		var fanhui = new Ext.Button({text:"返回",iconCls:"p-icons-unpassing",handler:this.returnMain,scope:this});
	...
	selectExamRoom:function() {
		...
		var iframe="<fieldset style='height:100%; width:100%; border:0px; padding:0;'>"+
						"<iframe id='frmReportSb' name='frmReportSb' width='100%' height='800' src='../subExamRoomArrange_getExamRoomArrange.do?lcId="+
						getLocationPram("lcid")+"&lfid="+jxl_id+"&kdid="+kdmc_id+"' frameborder='0' scrolling='auto'></iframe>"+
				   "</fieldset>";
		Ext.getDom("context_panel").innerHTML=iframe;
		//安排
    	/*Ext.Ajax.request({
			url: 'examroomarrange_arrangeStu.do',
		   	success: function(){
