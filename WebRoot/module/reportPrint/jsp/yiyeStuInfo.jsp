...
<body style="font-size:12px">
	<div pagetitle="pagetitle" style="font-size:26px;font-weight:bold;margin-left:auto;margin-right:auto;text-align:center;"> 
		<div id="table_title" style="margin-left:auto;margin-right:auto;text-align:center;">
			<label style="font-size: 26px;">不通过申请统计表</label>
		</div>
	</div>		
...
<%		for(int i=0;i<list.size();i++){
			...
			<tr>
				...
				<td><%=map.get("BJMC")==null?"":map.get("BJMC")%></td>
				<td><%=map.get("CDATE")==null?"":map.get("CDATE")%></td>
				<td><%=map.get("REASON")==null?"":map.get("REASON")%></td>
				<td><%=map.get("SFFZ")==null?"":map.get("SFFZ")%></td>
			</tr>						
<%		}%>
		</tbody>
	</table>
