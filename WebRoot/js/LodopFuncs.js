...
function getLodop(oOBJECT,oEMBED){
    ...
    try{
        ...
        if (LODOP.VERSION<"6.2.0.8") {
            if (needCLodop())
            document.documentElement.innerHTML=strCLodopUpdate; else
        ...
        LODOP.SET_LICENSES("湖南嘉杰信息技术有限公司","B3A7BF8932E17DF101C7D1E7F683CA3A","湖南嘉傑信息技術有限公司","38099AC519C169C2FED52EC4106A7435");
        //===========================================================
        return LODOP;
