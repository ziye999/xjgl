...
public class ManagementAction extends BaseAction{
	...
	public void updateCqxs()throws IOException{
		MsgBean mb = registrationService.updateEaxminee(bmlcid);
		HttpServletResponse response = getResponse();
		response.setCharacterEncoding("UTF-8");  
		response.setContentType("text/html; charset=gbk");
		response.getWriter().print(new Gson().toJson(mb));
	...
	public ManagementService getRegistrationService() {
		return registrationService;
	}
	public void setRegistrationService(ManagementService registrationService) {
