...
@Controller
@Scope("prototype")
public class ExamTeacherArrangePASAction extends BaseAction implements ModelDriven<CusKwMonitorteacher>{
	...
	public void getListPage() {
		...
		String xmgh = getRequest().getParameter("xmgh");
		writerPrint(examTeacherArrangeService.getPASListPage(lcid,kdid,xmgh).getResultList());
	}
