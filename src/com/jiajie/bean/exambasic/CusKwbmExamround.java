...
public class CusKwbmExamround implements java.io.Serializable {
	...
	/** default constructor */
	public CusKwbmExamround() {
	}

	/** full constructor */	
	public CusKwbmExamround(String lcid, String xnxqId, String xqm,
			String examname, String startweek, String startday, Date startdate,
			String endweek, String endday, Date enddate, String examtypem,
			String dwid, String dwtype, String xn, String bmlcid) {
		super();
		this.lcid = lcid;
		this.xnxqId = xnxqId;
		this.xqm = xqm;
