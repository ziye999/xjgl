...
@Controller
@Scope("prototype")
public class ExamTeacherArrangeHasAction extends BaseAction implements ModelDriven<CusKwMonitorteacher>{
	...
	public void getListPage() {
		...
		writerPrint(examTeacherArrangeService.hasArrangeInvigilatorTeacher(lcid,kdid,kcid,rcid,njid).getResultList());
	}
