Ext.ns('Ext.ux.form');
Ext.ux.form.OrganField = Ext.extend(Ext.form.TextField,{
	unitText:"",
	EnterQueryHandler:"",	
	checkModel:'cascade', 
	singleSelection:false,//是否单选。true为单选，默认为false。只有当type属性！=1时才能发挥作用。
	initComponent: function(){  
		Ext.ux.form.OrganField.superclass.initComponent.call(this);
		var thiz = this;  
		var tree = new Ext.tree.TreePanel({  
            ...
            loader : new Ext.tree.TreeLoader({  
            	dataUrl : 'dropListAction_getOrganTree.do?type=' + this.type
            }), 
            tbar:{
				items:[ 
	...
	onRender : function(ct, position) {   
		Ext.ux.form.OrganField.superclass.onRender.call(this, ct, position);	        
...
Ext.reg("uxorganfield",Ext.ux.form.OrganField);