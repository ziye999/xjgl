...
Ext.extend(Ext.ux.form.TimePickerField, Ext.form.Field, {
	...
	onRender: function(ct, position){
		...
		if(this.value) {
			...
			values=Ext.isDefined(this.values)?this.values:{h:this.date.getHours(), m:this.date.getMinutes(), s:this.date.getSeconds()};;
		}
...
Ext.DateTimePicker = Ext.extend(Ext.DatePicker, {
    ...
    setValue : function(value){
        var old = this.value;
        if (!this.tf){        	
            this.tf = new Ext.ux.form.TimePickerField({values:this.values});           
...
Ext.ux.form.DateTimeField = Ext.extend(Ext.form.DateField, {
    ...
    initComponent:function() {
        ...
        if(this.value && this.values){
        	this.value.setHours(this.values.h);
        	this.value.setMinutes(this.values.m);
        	this.value.setSeconds(this.values.s);
        }                      
    },
    getValue : function(){
    ...
    onTriggerClick : function(){
        ...
        this.menu.picker.values=this.values;
