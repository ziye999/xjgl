 ...
 */
public class CusKwSqCkdw implements
	...
	/** minimal constructor */
	public CusKwSqCkdw(String xxjbxxid) {
		this.xxjbxxid = xxjbxxid;
	}

	/** full constructor */

	public CusKwSqCkdw(String xxjbxxid, String xxbsm, String xxmc,
			String xxywmc, String xxdz, String sszgjyxzdm, String sszgjyxzmc,
			String xzxm, String xzsjhm, String bgdh, String yzbm,
			String dwdzxx, Long xxxz, String lrr, String lrsj, String gxr,
			String gxsj, String dwlx, String zt) {
		super();
		this.xxjbxxid = xxjbxxid;
		this.xxbsm = xxbsm;
		this.xxmc = xxmc;
