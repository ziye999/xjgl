...
Ext.extend(system.application.baseClass, {
	...
	createMainPanel:function(){
		...
		this.grid = new Ext.ux.GridPanel({
					...
					excelTitle : "成绩导入模板",
					fields : ["BMLCID","XN","XQ","KSMC","ZKDW","CKDW","KSSL","HGRS","WHGRS","YK","QK"],
					border : false
		});
...
//		"->",{xtype:"button",text:"返回",iconCls:"p-icons-unpassing",handler:this.fanhui,scope:this
		this.grid1 = new Ext.ux.GridPanel({
					...
					region : "center",
					excel : true,
					action : "resultsList_getStudentScore.do",
					excelTitle : "成绩导入模板",
	...
	selectstudent:function(){
    	...
    	this.grid1.$load({"bmlcid":bmlcid,"name":name,"sfzjh":sfzjh,"sfhg":sfhg,"wj":wj});
	},
